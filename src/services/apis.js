...
const monthlyAppointmentsURL = baseURL + "monthlyappointments";
const todaysAppointmentsURL = baseURL + "todaysappointments";
...
export function fetchAllAppointments() {
  return fetch(allAppointmentsURL).then(resp => resp.json());
}

export function fetchAllPatients() {
  return fetch(allPatientsURL).then(resp => resp.json());
}

export function fetchAllDoctors() {
  return fetch(allDoctorsURL).then(resp => resp.json());
}
...
export function addAppointmentBackend(newAppointment) {
...
export function fetchMonthlyAppointments() {
  return fetch(monthlyAppointmentsURL).then(resp => resp.json());
}

export function fetchTodaysAppointments() {
  return fetch(todaysAppointmentsURL).then(resp => resp.json());
}
